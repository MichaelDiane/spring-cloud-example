...
public class SpringBootExampleGatewayApplication {
	...
	/***
	 * @Title SpringBootExampleGatewayApplication.serviceRouteMapper
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringBootExampleGatewayApplication.class, args);
	}
}
